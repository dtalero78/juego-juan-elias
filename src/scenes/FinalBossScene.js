...
export default class FinalBossScene extends Phaser.Scene {
  ...
  create() {
    ...
    ['dolphinShoot','finalBossSpread','finalBossRay','finalBossDied','finalBossPhase2',
     'dolphinJump','dolphinDash','dolphinFrenzy','colombiaJump','colombiaDash','colombiaPunch','colombiaSpecial',
     'colombiaAttack','colombiaEnergyBall','colombiaKnifeSlash','colombiaModeChange','triangleJump','triangleDash','triangleShoot',
     'triangleShield','triangleFireball','triangleMegaFireball','clonJump','clonDash','clonShoot','clonMelee','clonModeChange',
  ...
  createUI() {
    ...
    if (this.selectedCharacter === 'dolphin') {
      ...
      this.ammoText = this.add.text(10, 34, 'ESPACIO: Tormenta Magnética (x3) | Q: cambiar | X: Dash', {
        fontSize: smallFontSize, fill: '#FF00FF', fontFamily: 'Courier New',
        backgroundColor: '#000000aa', padding: { x: 4, y: 2 }
      });
    } else if (this.selectedCharacter === 'clon') {
      this.ammoText = this.add.text(10, 34, 'ESPACIO: Plasma Nova (3/3) | Q: cambiar | X: Dash', {
        fontSize: smallFontSize, fill: '#00AAFF', fontFamily: 'Courier New',
        backgroundColor: '#000000aa', padding: { x: 4, y: 2 }
      });
    } else if (this.selectedCharacter === 'colombiaBall') {
      this.ammoText = this.add.text(10, 34, 'ESPACIO: Combo → Bola de energía | Q: cambiar | X: Dash', {
        fontSize: smallFontSize, fill: '#FF6600', fontFamily: 'Courier New',
        backgroundColor: '#000000aa', padding: { x: 4, y: 2 }
      });
    }
